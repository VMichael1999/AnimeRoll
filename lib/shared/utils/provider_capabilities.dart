...
enum ProviderId {
  ...
  /// flujo genérico de búsqueda multi-proveedor. Hoy: HentaiLA + MonosChinos.
  bool get isScoped =>
      this == ProviderId.hentaila || this == ProviderId.monoschinos;

  /// Si el backend expone `/schedule` para este proveedor. Solo AnimeAV1
  /// publica horario semanal real; el resto del módulo `/schedule` lo
  /// orquesta sobre AV1.
  ...
  /// Si el proveedor tiene una pantalla home con diseño dedicado (HentaiLA y
  /// MonosChinos lo tienen; AnimeAV1 usa la home genérica).
